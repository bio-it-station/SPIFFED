...
def main():
	...
	#
	# # Save scoreCalc
	# with open(output_dir+'_scoreCalc.pl', 'wb') as scoreCalc_file:
	# 	pickle.dump(scoreCalc, scoreCalc_file)

	# print("scoreCalc.scores.shape: ", scoreCalc.scores.shape)
	# print("scoreCalc.num_cores: ", scoreCalc.num_cores)
	# print("scoreCalc.num_cores: ", scoreCalc.num_cores)
	# print("scoreCalc.outF: ", scoreCalc.outF)
	# print("scoreCalc.verbose: ", scoreCalc.verbose)
	# print("scoreCalc.elutionData: ", scoreCalc.elutionData)
	# print("scoreCalc.scores: ", scoreCalc.scores)
	# print("scoreCalc.header: ", scoreCalc.header)
	# print("scoreCalc.ppiToIndex: ", scoreCalc.ppiToIndex)
	# print("scoreCalc.cutoff: ", scoreCalc.cutoff)
	# print("scoreCalc.features: ", scoreCalc.features)
	# print("scoreCalc.to_predict: ", scoreCalc.to_predict)
	# print("scoreCalc.scoreF: ", scoreCalc.scoreF)
	# print("scoreCalc.fun_anno: ", scoreCalc.fun_anno)

	# Load scoreCalc
	with open(output_dir+'_scoreCalc.pl', 'rb') as scoreCalc_file:
		scoreCalc = pickle.load(scoreCalc_file)
	# print("elutionData: ", scoreCalc.elutionData == scoreCalc_2.elutionData)

	# List_flat_all = (functools.reduce(operator.iconcat, scoreCalc.scores == scoreCalc_2.scores, [])).all()

	# print("scores.all(): ", (scoreCalc.scores == scoreCalc_2.scores).all() )
	# print("header: ", scoreCalc.header == scoreCalc_2.header)
	# print("ppiToIndex: ", scoreCalc.ppiToIndex == scoreCalc_2.ppiToIndex)
	#
	# print("features: ", scoreCalc.features)
	# print("features: ", scoreCalc_2.features)
	#
	# print("to_predict: ", scoreCalc.to_predict == scoreCalc_2.to_predict)
	# print("scoreF: ", scoreCalc.scoreF == scoreCalc_2.scoreF)
	# print("fun_anno: ", scoreCalc.fun_anno == scoreCalc_2.fun_anno)

	# print("scoreCalc.scores.shape: ", scoreCalc.scores.shape)
	# print("scoreCalc_2.scores.shape: ", scoreCalc_2.scores.shape)
	# print("scoreCalc_2.scores.shape: ", scoreCalc_2.scores.shape)
	# print("scoreCalc_2.num_cores: ", scoreCalc_2.num_cores)
	# print("scoreCalc_2.num_cores: ", scoreCalc_2.num_cores)
	# print("scoreCalc_2.outF: ", scoreCalc_2.outF)
	# print("scoreCalc_2.verbose: ", scoreCalc_2.verbose)
	# print("scoreCalc_2.elutionData: ", scoreCalc_2.elutionData)
	# print("scoreCalc_2.scores: ", scoreCalc_2.scores)
	# print("scoreCalc_2.header: ", scoreCalc_2.header)
	# print("scoreCalc_2.ppiToIndex: ", scoreCalc_2.ppiToIndex)
	# print("scoreCalc_2.cutoff: ", scoreCalc_2.cutoff)
	# print("scoreCalc_2.features: ", scoreCalc_2.features)
	# print("scoreCalc_2.to_predict: ", scoreCalc_2.to_predict)
	# print("scoreCalc_2.scoreF: ", scoreCalc_2.scoreF)
	# print("scoreCalc_2.fun_anno: ", scoreCalc_2.fun_anno)
