...
class CalculateCoElutionScores():
	...
	def calculateScores(self, toPred, tokeep=set([]), protein_list=[]):
		...
		for ppi in toPred:
			...
			# print("calculateScores ppi: ", ppi)

			proteins = ppi.split("\t")
			# print("proteins[0]: ", proteins[0])
			# print("proteins[1]: ", proteins[1])
...
class CLF_Wrapper:
	...
	def __init__(self, num_cores, classifier_select="RF", useFeatureSelection= False, num_ep=2, num_frc=60):
		self.num_cores = num_cores
		# if forest:
